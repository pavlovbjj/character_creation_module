...
def attack(char_name, char_class):
    """Вычисляет количество урона во время отаки."""
...
def defence(char_name, char_class):
    """Вычисляет количество урона, полученного при защите."""
    if char_class == 'warrior':
...
def special(char_name, char_class):
    """Вычисляет увеличение урона при использовании специального оружия."""
    if char_class == 'warrior':
...
def start_training(char_name, char_class):
    """Обучает управлению своими навыками."""
    if char_class == 'warrior':
